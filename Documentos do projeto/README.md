# Documentos do Projeto — MoneyIQ Personal

Índice da documentação técnica e de usuário do **MoneyIQ Personal — Sistema de
...
| [Diagrama de Casos de Uso](moneyiqpersonal_use_case_diagram.html) | Ator e casos de uso (UC01–UC08) — UML em Mermaid. |
| [Diagrama de Dados (DER)](moneyiqpersonal_DER.html) | Modelo entidade-relacionamento com as 8 entidades — Mermaid. |
| [Diagrama de Classes](moneyiqpersonal_class_diagram.html) | Classes do modelo de domínio (entidades JPA) e relacionamentos — Mermaid. |
| [Diagrama de Componentes](moneyiqpersonal_component_diagram.html) | Interações entre os componentes (clientes → segurança → controllers → services → repositories → banco) — Mermaid. |
...
| 4.3 Diagrama de casos de uso | [Casos de Uso](moneyiqpersonal_use_case_diagram.html) |
...
| 4.7 Diagrama de dados (DER) | [DER](moneyiqpersonal_DER.html) |
| 4.8 Diagrama de classes do modelo de dados | [Diagrama de Classes](moneyiqpersonal_class_diagram.html) |
| 4.8 Diagrama de interações entre componentes (CP3) | [Diagrama de Componentes](moneyiqpersonal_component_diagram.html) |
...
Definições no pacote `backend/springboot-api/src/main/java/com/moneyiqpersonal/backend/model`.
