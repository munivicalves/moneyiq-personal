 ...
 * Sentinel Prime, injetando o token JWT (quando houver) no header Authorization.
 *
 * Produção (Render): https://sentinel-prime-api.onrender.com/api/
 * Emulador apontando ao backend local: http://10.0.2.2:8080/api/
 */
public final class ApiClient {

    private static final String BASE_URL = "https://sentinel-prime-api.onrender.com/api/";
